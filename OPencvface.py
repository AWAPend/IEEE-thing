...
while True:
    ...
    frontal_faces = face_cascade_frontal.detectMultiScale(gray_frame, scaleFactor=1.1, minNeighbors=5, minSize=(30, 30))

    #Detect profile faces in the frame
    profile_faces = face_cascade_profile.detectMultiScale(gray_frame, scaleFactor=1.1, minNeighbors=5, minSize=(30, 30))
